    ...
    <div class="modal" style="max-width:700px;padding:0;overflow:hidden">
      ...
      <div v-if="form" style="padding:20px 24px;max-height:65vh;overflow-y:auto">
        <div class="form-grid" style="margin-bottom:16px">
          ...
          <div class="form-group"><label>RELEASE DATE <span style="color:var(--gray);font-weight:400;font-size:11px">(if released)</span></label><DateInput v-model="form.releaseDate" /></div>
